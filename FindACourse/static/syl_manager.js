...
wish to show 
*/
function showEmailWindow(divID, profName, majorCode, courseNum, courseTitle){
	console.log("show email window");
	var curDiv = document.getElementById(divID);
	document.getElementById("majorCode").innerHTML = majorCode.toString();
	document.getElementById("courseNum").innerHTML = courseNum.toString();
	document.getElementById("courseTitle").innerHTML = courseTitle.toString();
...
/* Sends an email */
function sendEmail(msg_div_id,msg_id){
	
	var msg_input = document.getElementById(msg_id);
	var message = document.getElementById(msg_div_id).innerHTML;
...
sending the email
*/
function showIndEmail(profName, majorCode, courseNum, courseTitle){
	showEmailWindow("ind_email", profName, majorCode, courseNum, courseTitle);
