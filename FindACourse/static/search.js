...
function toggleFilter(closeFilter){ 
	...
	var logo = document.getElementById('davidson_logo');
	...
	if (closeFilter){
		...
		main.style.width = "75%";/*"calc(100% - 180px)";*/
		main.style.marginLeft = "25%";
		/*logo.style.width = "calc(100% - 180px)";*/
...
function hideDiv(loopIndex) {
	...
	var resultSpan = String(parseInt(document.getElementById("count").innerHTML) - 1);
...
function mainPageSetup(searchBox){
	//document.getElementById("top").style.width = "75%";
	...
	document.getElementById("search_bar").style.width = "45%"; //"calc(100% - 180px)" //'75%';
...
function resultsPageSetup(searchBox){
	...
	searchBox.style.height = "55px";
	searchBox.style.paddingTop = "0px";
	var resultInfo = document.getElementById("results-btns");
	resultInfo.style.width = "100%"; /*80*/
	resultInfo.style.margin = "0 auto";
	resultInfo.style.height = "55px";
	resultInfo.style.paddingTop = "0px";
	
	document.getElementById("main").style.marginLeft = "25%";
	document.getElementById("by_keyword_home").style.display = "inline-block";
	document.getElementById("search_bar").style.display = "inline-block"; 
	document.getElementById("search_bar").style.margin = "0 auto";/*180*/
	document.getElementById("search_bar").style.width = '98%';
	document.getElementById("search-by-keyword").style.width = "165px";
	document.getElementById("search_home").style.width = "75%";
	document.getElementById("search_btn_home_td").style.width = "5%";
	document.getElementById("help_td").style.display = 'block';
	document.getElementById("descript_page").style.display = "none";
