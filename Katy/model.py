...
class Course(object):
    ...
    def get_sett_id(self):
        ...
        if (("reg for crn" in title) or ("register for crn" in title)):
        ...
        return ",".join([str(self.acad_period),str(crn),
                        str(self.instructor1),str(self.class_time),
                        str(self.seq_num)])    
    ...
    def privacy(self):
        ...
        try:
            setting = Settings.query.filter(Setting.id==setting_id).first()
    ...
    def learning_outcomes(self):
        ...
        try:
            ...
            return "Cut learning outcomes from syllabus and paste them here"
...
class Faculty(object):
    ...
    def primary_classes(self,acd):
        ...
        classes = (Course.query.filter(Course.instructor1_id==prof_id).
                   filter(Course.acad_period==acd)).all()
        return classes
